#Supervisors Code Challange
  ##About the Stack and code
	...
	- Composer 
    - Code is in PHP
    There No Need for a database, however there is commented code in the Dockerfile located
at docker/php/Dockerfile that will install either mySQL or PostgreSQL on the Docker image 
